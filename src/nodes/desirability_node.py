...
class DesirabilityAnalyzer:
    ...
    def identify_customer_segment(self, startup_idea: str, idea_description: str) -> Dict:
        ...
        try:
            ...
            customer_data = {"raw_response": response.content}
    ...
    def research_market_shifts(self, startup_idea: str, customer_segment: str) -> Dict:
        ...
        try:
            shifts_data = json.loads(response.content)
        except:
            shifts_data = {"raw_response": response.content}
    ...
    def research_existing_alternatives(self, startup_idea: str, customer_segment: str) -> Dict:
        ...
        try:
            alternatives_data = json.loads(response.content)
        except:
            alternatives_data = {"raw_response": response.content}
    ...
    def analyze_solution_fit(self, startup_idea: str, idea_description: str, 
        ...
        try:
            solution_fit_data = json.loads(response.content)
        except:
            solution_fit_data = {"raw_response": response.content}
    ...
    def generate_desirability_score(self, customer_data: Dict, shifts_data: Dict, 
        ...
        try:
            final_score_data = json.loads(response.content)
        except:
            final_score_data = {"raw_response": response.content}
